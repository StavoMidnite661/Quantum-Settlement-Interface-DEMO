...
export const BrainCircuitIcon: React.FC<IconProps> = (props) => (
    <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M12 12a2.5 2.5 0 0 1 2.5-2.5h0A2.5 2.5 0 0 1 17 12v3.5a2.5 2.5 0 0 1-2.5 2.5h0A2.5 2.5 0 0 1 12 15.5V12Z" />
      <path d="M12 12a2.5 2.5 0 0 0-2.5-2.5h0A2.5 2.5 0 0 0 7 12v3.5a2.5 2.5 0 0 0 2.5 2.5h0A2.5 2.5 0 0 0 12 15.5V12Z" />
      <path d="M15.5 22a2.5 2.5 0 0 0 2.5-2.5v0a2.5 2.5 0 0 0-2.5-2.5h-3A2.5 2.5 0 0 0 10 19.5v0a2.5 2.5 0 0 0 2.5 2.5h3Z" />
      <path d="M8.5 22a2.5 2.5 0 0 1-2.5-2.5v0A2.5 2.5 0 0 1 8.5 17h3a2.5 2.5 0 0 1 2.5 2.5v0a2.5 2.5 0 0 1-2.5 2.5h-3Z" />
      <path d="M12 7.5V12" />
      <path d="M12 16.5V12" />
    </svg>
);
